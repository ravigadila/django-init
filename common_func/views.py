...
class RegisterView(CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy("common_func:thank_you")

    def dispatch(self, request, *args, **kwargs):
        """If your already logged In Redirect To Dashboard
        """
        if request.user.is_authenticated():
            return HttpResponseRedirect(reverse("common_func:home"))
...
class LogInView(LoginView):
    ...
    success_url = reverse_lazy("common_func:dashboard")
...
class LogOutView(View):
    ...
    def get(self, request):
        logout(request)
        return HttpResponseRedirect(reverse("common_func:home_page"))
...
class ProfileEdit(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy("common_func:dashboard")
...
class ForgotPassword(PasswordResetView):
    ...
    success_url = reverse_lazy('common_func:password_reset_done')
...
class PasswordResetConfirmationEmail(PasswordResetConfirmView):
    ...
    success_url = reverse_lazy('common_func:password_reset_complete')
